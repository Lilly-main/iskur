			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-lg-row-fluid">
					...
					<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
						<!--begin::Image-->
						<img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="assets/media/auth/bg5.jpg" alt="" />
						...
						<div class="w-md-400px">
							...
							<form class="form w-100" action="{{route(('login_process'))}}" method="POST">
								...
								<div class="fv-row mb-8">
									<!--begin::Email-->
									<input type="number" placeholder="T.C. Numarası" name="id_number" autocomplete="off" class="form-control bg-transparent" />
									<!--end::Email-->
								</div>
								<!--end::Input group=-->
								...
								<div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
									<div></div>
									<!--begin::Link-->
									<a href="../../demo3/dist/authentication/layouts/overlay/reset-password.html" class="link-primary">Şifreni mi unuttun balık hafızalı?</a>
									<!--end::Link-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Submit button-->
								...
								<!--end::Submit button-->
								<!--begin::Sign up-->
								<div class="text-gray-500 text-center fw-semibold fs-6">henüz üye değil misin?
